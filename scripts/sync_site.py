...
if site==Path('/Users/goni/prepare-site'):raise SystemExit('Personal website is protected; use the organization checkout.')
...
description='Filecraft PDF copies locally, check personal requirements and verify saved bytes with an unsigned receipt.'
