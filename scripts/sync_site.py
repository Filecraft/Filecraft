...
for source,target in [('desktop/README.md','DESKTOP-SUITE.md'),('docs/DEPENDENCIES.md','DEPENDENCIES.md'),('docs/LICENSING.md','LICENSING.md'),('docs/PRODUCT-DECISION-09.md','PRODUCT-DECISION-09.md')]:
...
url='https://gonisulaimann.github.io/workspace/'
meta=f'<link rel="canonical" href="{url}"><meta name="description" content="{description}"><meta property="og:type" content="website"><meta property="og:title" content="Prepare local workspace"><meta property="og:description" content="{description}"><meta property="og:url" content="{url}"><meta property="og:image" content="https://gonisulaimann.github.io/assets/social-preview.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Prepare local workspace"><meta name="twitter:description" content="{description}"><meta name="twitter:image" content="https://gonisulaimann.github.io/assets/social-preview.png">'
